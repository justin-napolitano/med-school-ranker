...
SHEETS = [
    ...
    ("School Visibility", SCHOOL_VISIBILITY_CSV),
    ("School Dossiers", SCHOOL_DOSSIERS_CSV),
...
def add_instructions_sheet(wb: Workbook) -> None:
    ...
    rows = [
        ...
        ["Primary tabs", "Project Subplans, School Master, Applicant Profiles, Admissions Stats, Cost and Debt, Admissions Policies, Letter Requirements, Source Review Queue, Partner Inputs, School Visibility, School Dossiers, Calculated Rankings, Final Application List, Data Quality."],
